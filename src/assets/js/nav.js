...
// Pricing page segmented control (Websites / Reviews / Website + Reviews)
const segButtons = Array.from(document.querySelectorAll("#pricing-1262 .cs-seg-btn"));
const segPanels = Array.from(document.querySelectorAll("#pricing-1262 .cs-panel"));
