...
tags:
  - post
image: /assets/images/blog/6-months.png
imageAlt: Google Search Console 6 month performance data showing 41,400 impressions and 409 clicks
...
<iframe src="/assets/images/blog/hub-spoke-seo-diagram-eskerdesigns.html" style="width:100%; height:900px; border:none; border-radius:12px;" loading="lazy" title="Hub and Spoke SEO Architecture Diagram"></iframe>
...
![Google Search Console 6 month performance chart showing 41,400 impressions and 409 clicks](/assets/images/blog/6-months.png "Google Search Console — 6 month performance view")
...
![Google Search Console top queries tab showing ADU-related keywords dominating](/assets/images/blog/queries-tab.png "Google Search Console — top queries")
...
*Want to see what this architecture might look like for your business? [Book a free call](/get-started/) and we can map it out together.*
...
A single services page tries to rank for many different things at once. Hub and spoke gives each service its own dedicated URL with focused, specific content. Google rewards specificity — a page that's entirely about bathroom remodeling in Maine will rank better for bathroom remodeling searches than a page that mentions bathroom remodeling among ten other services. The same structure works for professional services. Our [Vermont law firm SEO service](/service-offerings/vermont-law-firm-seo-service/) is built on it: one page per practice area.
