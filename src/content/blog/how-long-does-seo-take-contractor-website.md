...
tags:
  - post
image: /assets/images/blog/how-long-does-seo-take.png
imageAlt: Google Search Console data showing 6 months of growth for a roofing contractor website
---
...
What follows is real Search Console data from [Metal Vista Roofing](https://metalvistaroofing.com), a Vermont-based roofing contractor serving markets across the border in upstate New York. The data is unedited. Month by month, impression by impression, this is exactly what happened after we launched their site from scratch.
...
<iframe
  src="/assets/images/blog/metalvista-stats-card.html"
  style="width:100%; border:none; border-radius:10px; overflow:hidden;"
  loading="lazy"
  title="6-month stats summary — metalvistaroofing.com"
></iframe>

<iframe
  src="/assets/images/blog/metalvista-growth-chart.html"
  style="width:100%; height:420px; border:none; border-radius:10px; overflow:hidden;"
  loading="lazy"
  title="Impressions and clicks growth chart — metalvistaroofing.com"
></iframe>
...
<iframe
  src="/assets/images/blog/metalvista-top-pages.html"
  style="width:100%; height:560px; border:none; border-radius:10px; overflow:hidden;"
  loading="lazy"
  title="Top pages by performance — metalvistaroofing.com"
></iframe>
...
If you want to understand what this could look like for your specific business and market, [I offer a free website review](/small-business-seo-services/) — no pitch, no pressure. Just an honest look at where you're at and what it would actually take to move the needle.

And if you want to see a full breakdown of what six months looked like for a different contractor — including the content architecture, the keyword data, and exactly which pages drove the most traffic — [we wrote about that here](/blog/do-small-businesses-need-seo-case-study/).
...
Often, yes — especially in less competitive markets. A roofing contractor in a mid-sized Vermont market is going to see results faster than someone trying to rank nationally for a broad term. Local search has a smaller competitive pool, and geographic-specific content can establish relevance quickly. [Here's a deeper look at local SEO strategy for small businesses](/blog/local-seo-for-small-businesses/) if you want to get into the specifics.

### Do I need a blog to rank on Google?

Not necessarily. The case study in this post and [the one we published here](/blog/do-small-businesses-need-seo-case-study/) are both examples of sites ranking well on service and location pages alone. Blogging helps — especially for capturing informational searches — but it's not required to get the phone ringing from organic traffic.
