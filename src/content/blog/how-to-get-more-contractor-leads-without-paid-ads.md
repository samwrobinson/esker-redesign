...
tags:
  - post
image: /assets/images/150-form-subs.png
imageAlt: A free lead generation system for contractors covering Google Business Profile, websites, referrals, and CRM automation
...
2. Your website
3. Referrals — but made systematic, not accidental
...
<iframe
  src="/assets/images/blog/gbp_optimization_checklist.svg"
  style="width:100%; height:520px; border:none; border-radius:10px; overflow:hidden;"
  loading="lazy"
...
I've written a whole separate article on [whether contractors actually need a website](/blog/do-contractors-need-a-website-2026/) (spoiler: most do), so I'm not going to go deep here. But I do want to make one point that's relevant to this conversation.
...
<iframe
  src="/assets/images/blog/lead_response_time_conversion.html"
  style="width:100%; height:420px; border:none; border-radius:10px; overflow:hidden;"
  loading="lazy"
  title="Lead response time vs. conversion rate for contractors"
></iframe>
...
<iframe
  src="/assets/images/blog/crm_automation_flow.svg"
  style="width:100%; height:560px; border:none; border-radius:10px; overflow:hidden;"
  loading="lazy"
  title="CRM automation flow — what happens when a lead comes in"
></iframe>
...
<iframe
  src="/assets/images/blog/crm_comparison_contractors.html"
  style="width:100%; border:none; border-radius:10px; overflow:hidden;"
  loading="lazy"
  title="CRM comparison table — Jobber vs GoHighLevel vs HubSpot"
></iframe>
...
2. Invoice sent
3. Invoice paid
4. 2-3 days later: automatic text to the customer with a direct link to your Google review page
